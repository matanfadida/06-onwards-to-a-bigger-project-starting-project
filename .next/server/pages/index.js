...
async function getStaticProps() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://matan:2JjrOiOBPnz5E1My@cluster0.1p1gd.mongodb.net/meetups?retryWrites=true&w=majority");
